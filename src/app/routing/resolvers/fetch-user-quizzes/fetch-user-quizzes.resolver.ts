...
/**
 * Retrieves a catalogue of all quizzes so that they can be loaded before navigating
 * to the page.
 * @param route 
 * @param state 
 * @returns 
 */
export const fetchUserQuizzesResolver: ResolveFn<IQuizList> = (route, state): Observable<IQuizList> => {
  ...
  return quizService.getUserQuizzes(
    userId,
